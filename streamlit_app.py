...
st.title("Chat with INFORMS Style Guide Copilot")
st.write(
...
if not openai_api_key:
    ...
    if "messages" not in st.session_state.keys():  # Initialize the chat messages history
        st.session_state.messages = [
            {"role": "assistant", "content": "I am INFORMS Copilot, your personal assistant. You can ask me any questions about INFORMS article guidelines."}
        ]
